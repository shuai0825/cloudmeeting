...
public class DownLoadBuilder {
    ...
    private static void downloadApk(Context context, String url, boolean isWIFI, String description, String downloadName) {
        ...
        LogUtils.d(Environment.DIRECTORY_DOWNLOADS);
    ...
    public void intallApk(Context context, String downloadName) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            File file = new File(
                    ...
                    , "/" + downloadName + ".apk");
            Uri apkUri =
                    FileProvider.getUriForFile(context, "com.pmcc.cloudmeeting.pd", file);
    ...
    BroadcastReceiver receiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals(DownloadManager.ACTION_DOWNLOAD_COMPLETE)) {
                intallApk(context, downloadName);
            }
        }
    };
}